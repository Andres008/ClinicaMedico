package ec.com.model.dao.manager;
 ...
 */
@Stateless(mappedName = "managerDAOSegbecom")
@LocalBean
public class ManagerDAOSegbecom {

	@PersistenceContext(unitName = "pryArtemisDs")
	private EntityManager em;

	/**
	 * Default constructor.
	 */
	public ManagerDAOSegbecom() {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List findWhere(Class clase, String pClausulaWhere, String pOrderBy) throws Exception {
	...
	public void insertar(Object pObjeto) throws Exception {
		...
		try {
			em.persist(pObjeto);
			em.flush(); // <-- aquí se ejecuta el INSERT y salta la violación de llave única

		} catch (PersistenceException e) {

			// Si quieres depurar qué viene adentro:
			Throwable causa = e;
			while (causa != null) {
				System.out.println("Causa: " + causa.getClass().getName() + " - " + causa.getMessage());
				causa = causa.getCause();
			}

			// IMPORTANTE: conservar la causa real
			throw new Exception(
					"No se pudo insertar el objeto especificado (" + pObjeto.getClass().getCanonicalName() + ").", e // <---
																														// aquí
																														// encadenas
																														// la
																														// causa
	...
	public void eliminar(Class clase, Object pID) throws Exception {
		...
		try {
			...
			throw new Exception(
					"No se pudo eliminar el dato (" + pID + ")(" + clase.getCanonicalName() + ") : " + e.getMessage());
		}
	}
	...
	public void actualizar(Object pObjeto) throws Exception {
		...
		try {
			...
			throw new Exception("No se pudo actualizar el dato solicitado (" + pObjeto.getClass().getCanonicalName()
					+ "): " + e.getMessage());
		}
	...
	public Long obtenerCantTramitesEjecutados(long idTramitePadre) throws Exception {
		String sentenciaSQL;
		Query q;
		int valTmp = 0;
		try {
			...
			e.printStackTrace();
			throw new Exception(
					"Error al obtener la cantidad de trámites ejecutados del Tramite Padre: " + idTramitePadre);
		}
	...
	/**
	 * Finder generico que permite aplicar la condicion Distinct a un campo y las
	 * clausulas where y order by.
	 * 
	 * @param clase          La entidad sobre la que se desea consultar. Ej:
	 *                       Usuario.class
	 * @param campoDistinct  Clausula en el campo del Select DISTINCT nombre del
	 *                       campo (sin la palabra reservada DISTINCT). Ejemplo:
	 *                       <ul>
	 *                       <li>o.nombreCampo</li>
	 *                       <li>o.nombreCampo1,o.nombreCampo2,o.nombreCampo
	 *                       ...</li>
	 *                       </ul>
	 * @param pClausulaWhere Clausula where de tipo JPQL (sin la palabra reservada
	 *                       WHERE). Ejemplo:
	...
	public List findDistinct(Class clase, String campoDistinct, String pClausulaWhere, String pOrderBy)
		...
		if (pOrderBy == null || pOrderBy.length() == 0)
			sentenciaSQL = "SELECT DISTINCT " + campoDistinct + " FROM " + clase.getSimpleName() + " o WHERE "
					+ pClausulaWhere;
